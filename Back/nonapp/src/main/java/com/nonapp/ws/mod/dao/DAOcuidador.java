...
public class DAOcuidador {
	...
	public boolean registrarCuidador(VOcuidador cuidador) throws SQLException{
		...
		try {
			...
			statement.setString(1, cuidador.getEmail()); 
			statement.setString(2, cuidador.getNombre());
			statement.setString(3, cuidador.getPassword());
