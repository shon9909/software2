...
function agregarCriterio() {
  var table =
  document.getElementById("tablaCriterios")
  var t = $("#termino").val()
  console.log(t)
  ...
  cell1.innerHTML = t
  cell2.innerHTML = '<td><div class="ui buttons"><button class="ui button">1</button><button class="ui button">2</button><button class="ui button">3</button><button class="ui button">4</button></div></td>'
}
...
if (rowCount <= 1)
  alert('No se puede eliminar estos criterios');
else
